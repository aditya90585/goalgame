    ...
    return (
        <div className={`fixed bg-[#212226] z-20 md:h-full h-[98%] md:w-[96%] w-[96%] top-1 md:left-[2%] left-[2%] rounded-xl overflow-y-scroll  ${GamerulesSelector ? "" : "hidden"}`}>
            ...
            <ul className='text-[#9B9B9B] w-[88%] mx-auto mt-3 flex flex-col gap-y-2'>
                <li>- Game is simple: go trough the field and avoid mines. With each revealed tile, payout multiplier increases. Tiles can be revealed by selecting certain tile in current row, or clicking “pick randomply” button; </li>
                <li>- Player can cash out winnings at any time by clicking “Cash out” button; </li>
                <li>- Field size can be adjusted from dropdown. This affects game odds and bet multiplier; </li>
                <li>- The maximum winning odds for this game are 9.033829X. However, the maximum win is limited by the operator and can be accessed from the “Game Limits” section in the menu. </li>
            </ul>
